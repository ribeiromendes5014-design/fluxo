# pages/cashback.py (SISTEMA DE CASHBACK)
...
# ==============================================================================
# FUNÇÃO PRINCIPAL QUE RENDERIZA O SISTEMA DE CASHBACK
# ==============================================================================

def render_cashback_system():
    # Removido st.set_page_config() daqui para evitar erro
    ...
    # Certifica-se de que a chave 'valor_venda' está inicializada no escopo principal do sistema de cashback
...
# Chamada da função para iniciar a página
render_cashback_system()