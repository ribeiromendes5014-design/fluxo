...
def livro_caixa():
    ...
    with tab_mov:
        ...
        if df_exibicao.empty:
            ...
            with col_f3:
                tipos_unicos = ["Todos", "Entrada", "Saída"]
